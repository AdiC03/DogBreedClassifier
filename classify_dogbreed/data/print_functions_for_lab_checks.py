...
# PURPOSE:  This set of functions is used to check the code.
...
def check_creating_pet_image_labels(results_dic):
    """    Checking: Creating Pet Image Labels
...
def check_classifying_labels_as_dogs(results_dic):
    """    Checking: Classifying Labels as Dogs
